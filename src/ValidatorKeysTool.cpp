...
void createToken (boost::filesystem::path const& keyFile)
{
    ...
    std::cout << "Update brtd.cfg file with these values and restart brtd:\n\n";
    ...
    boost::filesystem::path const& keyFile)
{
    ...
    std::cout << "\n";
    std::cout << "You also need to update the brtd.cfg file to add a new\n";
    std::cout << "validator token and restart brtd:\n\n";
    std::cout << "# validator public key: " <<
              toBase58 (TokenType::NodePublic, keys.publicKey()) << "\n\n";
    std::cout << "[validator_token]\n";
